...
| 5 | Khi không muốn sử dụng có thể chọn "Đăng xuất" để thoát khỏi hệ thống. |
| 6 | Khi quản trị viên chọn vào chức năng "Quản lý người dùng", hệ thống sẽ hiển thị danh sách tài khoản người dùng bao gồm các chức năng tìm kiếm, xem chi tiết, sửa, khóa/mở khóa tài khoản. |
...
| 14 | Quản trị viên có thể thêm/sửa/xóa các ngạch lương mới khi có thay đổi quy định. |
| 15 | Quản trị viên có thể quản lý số bậc và hệ số tương ứng cho mỗi ngạch. |
| 16 | Hệ thống lưu lịch sử thay đổi hệ số lương theo thời gian, có viết lý do sửa |
...
| 37 | Cán bộ TCCB có thể tải lên ảnh chân dung 3x4/4x6 của nhân viên. |
| 38 | Cán bộ TCCB có thể nhập thông tin ngân hàng gồm tên ngân hàng, số tài khoản, chi nhánh. |
| 39 | Cán bộ TCCB có thể nhập quá trình công tác trước khi vào trường. |
| 40 | Cán bộ TCCB có thể nhập thông tin Đảng viên gồm ngày vào Đảng, ngày chính thức, đảng bộ trực thuộc. |
| 41 | Cán bộ TCCB có thể nhập thông tin đoàn viên công đoàn. |
| 42 | Hệ thống tự động tạo mã cán bộ sau khi lưu hồ sơ mới. |
| 43 | Chức năng sửa cho phép cán bộ TCCB chỉnh sửa thông tin hồ sơ, sau đó xác nhận sửa. |
| 44 | Chức năng đánh dấu thôi việc cho phép cán bộ TCCB chọn hồ sơ cần đánh dấu thôi việc và xác nhận đánh dấu thôi việc. |
| 45 | Hệ thống lưu trữ lịch sử thay đổi hồ sơ, có viết lý do sửa. |
| 46 | Cán bộ TCCB có thể xem chi tiết hồ sơ hiển thị đầy đủ tất cả thông tin. |
...
| 78 | Cán bộ TCCB có thể chấm dứt hợp đồng với lý do, ngày chấm dứt, các khoản thanh toán. |
| 79 | Hệ thống tự động cảnh báo hợp đồng sắp hết hạn (số ngày cảnh báo có thể cấu hình). |
| 85 | Hệ thống tự động kiểm tra thời hạn tối thiểu, tối đa hợp đồng theo cấu hình. |
| 86 | Hệ thống tự động đề xuất chuyển đổi loại hợp đồng nếu gia hạn theo quy tắc cấu hình. |
...
| 101 | Cán bộ TCCB có thể tạo các khóa đào tạo thêm các thông tin khóa đào tạo gồm: thời gian, địa điểm, kinh phí, cam kết sau đào tạo, chứng chỉ sau đào tạo. |
| 101 | Cán bộ TCCB có thể cần mở các khóa đào tạo, thiết lập thời gian mở đăng ký, giới hạn người tham gia. |
...
| 120 | Lãnh đạo trường có thể xem báo cáo tổng hợp nhân sự theo đơn vị, toàn trường. |
| 121 | Lãnh đạo trường có thể xem báo cáo cơ cấu nhân sự theo trình độ, độ tuổi, giới tính. |
| 122 | Lãnh đạo trường có thể xem báo cáo biến động nhân sự gồm tuyển mới, nghỉ việc, điều chuyển. |
| 126 | Lãnh đạo trường có thể lập báo cáo theo kỳ (tháng, quý, năm). |
| 127 | Lãnh đạo trường có thể xuất báo cáo ra Excel, PDF, Word. |
...
| STT | Need |
|:---:|:---|
| 107 | Cán bộ Phòng TCKT phải "Đăng nhập" để sử dụng hệ thống, muốn đăng nhập phải sử dụng tên đăng nhập và mật khẩu. |
| 108 | Khi không muốn sử dụng cán bộ Phòng TCKT có thể chọn "Đăng xuất" để thoát khỏi hệ thống. |
| 34 | Khi cán bộ Phòng TCKT chọn vào chức năng "Quản lý hồ sơ nhân sự", hệ thống sẽ hiển thị danh sách hồ sơ nhân sự bao gồm các chức năng tìm kiếm, lọc, xem chi tiết | |
| 34 | Khi cán bộ Phòng TCKT chọn vào chức năng "Quản lý hồ sơ dữ liệu lương", hệ thống sẽ hiển thị danh sách hồ sơ nhân sự bao gồm các chức năng tìm kiếm, lọc, xem dữ liệu ngạch, hệ số, bậc lương, phụ cấp và các chỉ số | |
| 116 | Cán bộ TCKT có thể cung cấp API/Export dữ liệu lương của "Quản lý hồ sơ dữ liệu" cho hệ thống tính lương bên ngoài và cho phép chuyển đổi ra file Excel. |

---

## 6. Cán bộ/Giảng viên (Toàn bộ CBGV) - Cổng Self-Service
...
| 145 | Khi cán bộ/giảng viên chọn vào chức năng "Xem kết quả khen thưởng và kỷ luật". |
| 146 | Khi cán bộ/giảng viên chọn vào chức năng "Xem thông tin đào tạo", hệ thống hiển thị danh sách các khóa đào tạo, bồi dưỡng đã tham gia. |
| 150 | Khi cán bộ/giảng viên chọn vào chức năng "Đăng ký đào tạo", hệ thống hiển thị danh sách các khóa đào tạo đang mở đăng ký. |
...
| STT | Need |
|:---:|:---|
| 152 | Hệ thống phải đảm bảo thời gian phản hồi trang thông thường dưới 2 giây, báo cáo phức tạp dưới 10 giây. |
| 153 | Hệ thống phải hỗ trợ tối thiểu 500 người dùng đồng thời. |
| 155 | Hệ thống phải hỗ trợ xác thực bằng username/password. |
| 156 | Hệ thống phải phân quyền dựa trên vai trò. |
| 157 | Hệ thống phải mã hóa dữ liệu nhạy cảm và sử dụng HTTPS cho web. |
| 158 | Hệ thống phải ghi lại tất cả thao tác quan trọng. |
| 159 | Hệ thống phải tự động timeout phiên làm việc sau 30 phút không hoạt động. |
| 160 | Mật khẩu phải tối thiểu 8 ký tự, bao gồm chữ hoa, chữ thường, số. |
| 161 | Hệ thống phải đảm bảo uptime 99.5% trong giờ hành chính. |
| 162 | Hệ thống phải backup tự động hàng ngày, lưu trữ 30 ngày. |
| 163 | Hệ thống phải có khả năng phục hồi với RTO dưới 4 giờ, RPO dưới 24 giờ. |
| 164 | Hệ thống phải hỗ trợ lưu trữ hồ sơ tối thiểu 10 năm. |
| 165 | Hệ thống phải có kiến trúc cho phép mở rộng khi cần. |
| 166 | Hệ thống phải có giao diện tiếng Việt, thân thiện, responsive. |
| 167 | Người dùng mới phải sử dụng được các chức năng cơ bản sau 4 giờ đào tạo. |
| 168 | Hệ thống phải có tài liệu hướng dẫn sử dụng đầy đủ. |
| 169 | Hệ thống phải hỗ trợ truy cập từ mobile/tablet cho Self-Service Portal. |
| 172 | Hệ thống phải xuất dữ liệu tương thích với phần mềm kế toán. |
| 175 | Hệ thống phải hỗ trợ quản lý đa cơ sở: Hà Nội, Phố Hiến, TP.HCM. |
| 176 | Hệ thống phải tuân thủ Bộ Luật Lao động 2019. |
| 177 | Hệ thống phải tuân thủ Luật Bảo hiểm xã hội. |
| 178 | Hệ thống phải tuân thủ quy định thuế thu nhập cá nhân. |
| 179 | Hệ thống phải tuân thủ Luật Giáo dục 2019 và Luật Giáo dục đại học. |
| 180 | Hệ thống phải tuân thủ Luật Viên chức và các văn bản hướng dẫn. |
